...
<header class="main_menu single_page_menu">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light slideInDown slideInLeft duration-3s">
                    <lord-icon
                        src="https://cdn.lordicon.com/ndfdylqe.json"
                        trigger="morph"
                        colors="primary:#4be1ec,secondary:#1663c7"
...
<!-- Header part end-->
    ...
    <div class="container-xxl py-5">
        <div class="container align-content-center align-items-center">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 700px;">
                <h1 class="mb-3">What's your Favourite? </h1>
            </div>
            <div class="row g-3 justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInDown" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0"> Puzzles </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0"> Chess </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0"> Brain Games </h5>
                        </div>
                    </div>
                </div>
    ...
    <section class="">
        <div class="">
            <div class="row align-items-center justify-content-between" style="padding-left: 10px">
...
<div class="container-fluid bg-dark text-white-50 footer  wow fadeIn" data-wow-delay="0.1s">
        <div class="row g-4">
            ...
            <div class="row-lg-3 row-md-4" style="display: flex; flex-direction: row; margin: 7px;">
...
<div class="container">
    <div class="copyright">
        <div class="row">
            <div class="row-md-6 text-center text-md-start mb-3 mb-md-0 " style="color: #FFFFFF">
                Designed By <a class="border-bottom" href="https://www.facebook.com/profile.php?id=100011195175081"> Rayhan Mahmoud</a>
            </div>
